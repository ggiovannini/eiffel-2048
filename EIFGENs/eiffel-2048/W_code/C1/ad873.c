...
extern EIF_TYPED_VALUE F873_7122(EIF_REFERENCE);extern EIF_INTEGER_32 en_addrinfo_af_inet();

extern EIF_TYPED_VALUE F873_7123(EIF_REFERENCE);extern EIF_INTEGER_32 en_addrinfo_af_inet6();
...
EIF_TYPED_VALUE F873_7122 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 872, Current, 0, 0, 12750);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F873_7123 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 872, Current, 0, 0, 12751);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
