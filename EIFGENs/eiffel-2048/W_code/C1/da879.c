...
extern EIF_TYPED_VALUE F879_7253(EIF_REFERENCE);
extern EIF_TYPED_VALUE F879_7254(EIF_REFERENCE);
extern EIF_TYPED_VALUE F879_7255(EIF_REFERENCE);
extern EIF_TYPED_VALUE F879_7256(EIF_REFERENCE);
extern EIF_TYPED_VALUE F879_7257(EIF_REFERENCE);
extern EIF_TYPED_VALUE F879_7258(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F879_7251,12863,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 878, Current, 0, 0, 12863);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(878, Current, 12863);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F879_7253)
EIF_TYPED_VALUE F879_7253 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 878, Current, 0, 0, 12864);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(878, Current, 12864);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F9, 0,0); /* Result */
...
RTOID (F879_7254)
EIF_TYPED_VALUE F879_7254 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 878, Current, 0, 0, 12857);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
RTOID (F879_7255)
EIF_TYPED_VALUE F879_7255 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 878, Current, 0, 0, 12858);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
EIF_TYPED_VALUE F879_7256 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F879_7256,12860,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F879_7257 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F879_7257,12861,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F879_7258 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F879_7258,12862,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit879 (void)
{
	GTCX
	RTOTS (7251,F879_7251)
	RTOTS (7252,F879_7252)
	RTOTS (7253,F879_7253)
	RTOTS (7254,F879_7254)
	RTOTS (7255,F879_7255)
	RTOTS (7256,F879_7256)
	RTOTS (7257,F879_7257)
	RTOTS (7258,F879_7258)
}
