...
static EIF_TYPE_INDEX gen_type14_880 [] = {0xFF11,879,0xFFFF};
static EIF_TYPE_INDEX gen_type15_880 [] = {0xFF11,879,0xFFFF};
static EIF_TYPE_INDEX gen_type16_880 [] = {0xFF11,879,0xFFFF};
static EIF_TYPE_INDEX gen_type17_880 [] = {0xFF11,879,0xFFFF};


static struct desc_info desc_880[] = {
	{(BODY_INDEX) 12865, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	...
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 879, gen_type13_880},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 879, gen_type14_880},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 879, gen_type15_880},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 879, gen_type16_880},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 879, gen_type17_880},
};
