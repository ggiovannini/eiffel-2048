...
extern void F877_7238(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F877_7239(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define arg2 arg2x.it_r
	...
	RTEAA(l_feature_name, 876, Current, 0, 2, 12851);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(876, Current, 12851);
	RTCC(arg1, 876, l_feature_name, 1, eif_attached_type(217));
	RTCC(arg2, 876, l_feature_name, 2, eif_attached_type(165));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5163, 0xF80000D9, 0); /* identifier */
	
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(5163, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5164, 0xF80000A3, 0); /* output */
...
void F877_7238 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 876, Current, 0, 1, 12852);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(876, Current, 12852);
	RTCC(arg1, 876, l_feature_name, 1, eif_attached_type(217));
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	...
	ur2 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5160, dtype))(Current, ur1x, ur2x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F877_7239 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 876, Current, 0, 1, 12853);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(876, Current, 12853);
	RTCC(arg1, 876, l_feature_name, 1, eif_attached_type(217));
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 876, Current, 1, 1, 12856);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(876, Current, 12856);
	RTCC(arg1, 876, l_feature_name, 1, eif_attached_type(217));
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	ti4_2 = *(EIF_INTEGER_32 *)(tr2 + RTVA(4450, "count", tr2));
