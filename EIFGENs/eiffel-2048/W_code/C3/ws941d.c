/*
 * Class WSF_DEFAULT_RESPONSE_SERVICE
 */
...
static EIF_TYPE_INDEX gen_type13_941 [] = {0xFF11,880,0xFFFF};
static EIF_TYPE_INDEX gen_type14_941 [] = {0xFF11,896,0xFFFF};
static EIF_TYPE_INDEX gen_type15_941 [] = {0xFF11,884,0xFFFF};
...
static struct desc_info desc_941[] = {
	...
	{13632, (BODY_INDEX)-1, 880, gen_type13_941},
	...
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 896, gen_type14_941},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 884, gen_type15_941},
};
...
void Init941(void)
{
	...
	IDSC(desc_941 + 32, 415, 940);
	IDSC(desc_941 + 34, 440, 940);
	IDSC(desc_941 + 39, 378, 940);
	IDSC(desc_941 + 40, 414, 940);
}
