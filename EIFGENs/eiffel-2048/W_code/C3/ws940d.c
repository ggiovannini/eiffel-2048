...
static EIF_TYPE_INDEX gen_type13_940 [] = {0xFF11,880,0xFFFF};
static EIF_TYPE_INDEX gen_type14_940 [] = {0xFF11,896,0xFFFF};
...
static struct desc_info desc_940[] = {
	...
	{13632, (BODY_INDEX)-1, 880, gen_type13_940},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 896, gen_type14_940},
};
...
void Init940(void)
{
	...
	IDSC(desc_940 + 32, 415, 939);
	IDSC(desc_940 + 34, 378, 939);
}
