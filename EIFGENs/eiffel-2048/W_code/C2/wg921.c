...
extern void F921_7863(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F921_7863 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 920, Current, 1, 1, 13365);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(920, Current, 13365);
	RTCC(arg1, 920, l_feature_name, 1, eif_attached_type(217));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(5692, dtype));
...
body:;
	...
	loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5687, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(6);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5055, "put_string", loc1))(loc1, ur1x);
	RTHOOK(7);
	tr1 = RTMS_EX_H("Connection: close",17,955446373);
	ur1 = tr1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5055, "put_string", loc1))(loc1, ur1x);
	RTHOOK(8);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5059, "put_crlf", loc1))(loc1);
	RTHOOK(9);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5059, "put_crlf", loc1))(loc1);
	RTHOOK(10);
	RTDBGAA(Current, dtype, 5692, 0x04000000, 1); /* header_committed */
	
	*(EIF_BOOLEAN *)(Current + RTWA(5692, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(11);
