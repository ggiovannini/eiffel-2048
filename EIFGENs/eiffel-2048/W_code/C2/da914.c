...
extern EIF_TYPED_VALUE F914_7789(EIF_REFERENCE);
extern EIF_TYPED_VALUE F914_7790(EIF_REFERENCE);
extern EIF_TYPED_VALUE F914_7791(EIF_REFERENCE);
...
EIF_TYPED_VALUE F914_7789 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F914_7790 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F914_7791 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 913, Current, 0, 0, 13312);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(913, Current, 13312);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5587, "fractional_second", tr1));
