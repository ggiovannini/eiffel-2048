...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1004, Current, 0, 1, 13342);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1004, Current, 13342);
	RTCC(arg1, 1004, l_feature_name, 1, eif_attached_type(RTWCT(5666, Dtype(Current), Dftype(Current))));
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1004, Current, 0, 1, 13343);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1004, Current, 13343);
	RTCC(arg1, 1004, l_feature_name, 1, eif_attached_type(RTWCT(5667, Dtype(Current), Dftype(Current))));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
